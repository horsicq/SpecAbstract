...
{
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PACKER,           XScanEngine::RECORD_NAME_PKLITE,                       "1.00, 1.03",       "exe2com"},             "B8....BA....8CDB03D83B1E....73..83EB..FA8ED3BC....FB83EB..8EC353B9....33FF57BE....FCF3A5CB"},
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PACKER,           XScanEngine::RECORD_NAME_PKLITE,                       "1.00c",            ""},                    "BA....A1....2D....8CCB81C3....3BC377..05....3BC377..B4..BA....CD21CD20"},
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PACKER,           XScanEngine::RECORD_NAME_PKLITE,                       "1.12, 1.20",       ""},                    "B8....BA....3BC473..8BC42D....25....8BF8B9....BE....FCF3A58BD8B1..D3EB8CD903D95333DB53CB"},
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PACKER,           XScanEngine::RECORD_NAME_PKLITE,                       "1.15",             ""},                    "B8....BA....3BC473..8BC42D....9025....8BF8B9....90BE....FCF3A58BD8B1..D3EB8CD903D95333DB53CB"},
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PACKER,           XScanEngine::RECORD_NAME_PKLITE,                       "1.50",             ""},                    "50B8....BA....3BC473..8BC42D....25....8BF8B9....BE....FCF3A58BD8B1..D3EB8CD903D95333DB53CB"},
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PACKER,           XScanEngine::RECORD_NAME_PKLITE,                       "1.1x",             ""},                    "BA....B8....05....3B06....73..2D....FA8ED0FB2D....8EC050B9....33FF57BE....FCF3A5CB"},
	...
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PROTECTOR,        XScanEngine::RECORD_NAME_CRYPTDISMEMBER,               "1.7",              ""},                    "0E179C58F6C4..74..EB..90B4..BE....BF....B9....68....68....68....57F3A4C3"},
};
...
static NFD_Binary::SIGNATURE_RECORD g_COM_Exp_records[] =
{
	...
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PROTECTOR,        XScanEngine::RECORD_NAME_SPIRIT,                       "1.5",              ""},                    "E9$$$$369F9F1C..E9$$$$E8$$$$E421F80C..E6218D06....FC505089C1FB"},
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PROTECTOR,        XScanEngine::RECORD_NAME_SPIRIT,                       "1.5",              ""},                    "E9$$$$F8D72606B435CD2107E8$$$$1C..1C..33D226F6DA12DDFCF905....F8F5F6EA"},
	...
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PACKER,           XScanEngine::RECORD_NAME_DIET,                         "1.00, 1.00d",      ""},                    "BF....3BFC72$$BE....B9....FDF3A5FC8BF7BF....ADAD8BE8B2..E9"},
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PACKER,           XScanEngine::RECORD_NAME_DIET,                         "1.02b, 1.10a",     ""},                    "......BF....B9....3BFC72$$FDF3A5FC8BF7BF....ADAD8BE8B2..E9"},
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PACKER,           XScanEngine::RECORD_NAME_DIET,                         "1.20",             ""},                    "......BF....B9....3BFC72$$31DBEB$$FDF3A5FC8BF7BF....ADAD8BE8B2..E9"},
	...
	{{0, XBinary::FT_COM,       XScanEngine::RECORD_TYPE_PROTECTOR,        XScanEngine::RECORD_NAME_CRYPTCOM,                     "2.0",              ""},                    "E9$$$$BE....56B9....C704....C644....8134....4646E2..31F631C9C3"},
};

NFD_Binary::SIGNATURE_RECORD *NFD_COM::getHeaderRecords() { return g_COM_records; }
qint32 NFD_COM::getHeaderRecordsSize() { return sizeof(g_COM_records); }
NFD_Binary::SIGNATURE_RECORD *NFD_COM::getHeaderExpRecords() { return g_COM_Exp_records; }
qint32 NFD_COM::getHeaderExpRecordsSize() { return sizeof(g_COM_Exp_records); }
										 ...
										 XBinary::PDSTRUCT *pPdStruct)
{
	...
	if (com.isValid(pPdStruct) && XBinary::isPdStructNotCanceled(pPdStruct)) {
		...
		NFD_Binary::signatureScan(&result.basic_info.mapHeaderDetects,
					 result.basic_info.sHeaderSignature,
					 g_COM_records,
					 sizeof(g_COM_records),
					 result.basic_info.id.fileType,
					 XBinary::FT_COM,
					 &(result.basic_info),
					 DETECTTYPE_HEADER,
					 pPdStruct);

		NFD_Binary::signatureExpScan(&com,
					  &(result.basic_info.memoryMap),
					  &result.basic_info.mapHeaderDetects,
					  0,
					  g_COM_Exp_records,
